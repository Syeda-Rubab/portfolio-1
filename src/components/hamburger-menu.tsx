...
const HamburgerMenu: React.FC<HamburgerMenuProps> =({ links }) =>{
    ...
    const menuList = {
        start: {scale:0.6, opacity:0.7, y:0},
      ...
      return (
        <div className='md:hidden top-5 right-5 fixed w-60 z-[999] flex flex-col items-end gap-2'>
            ...
            border border-slate-400 dark:border-white border-opacity-40 shadow-2xl rounded-full 
            ...
            <AnimatePresence>
                ...
                initial="starts"
                animate="visible"
                className='w-full bg-white drop-shadow border border-slate-400 dark:border-white
                border-opacity-60 shadow-2xl rounded-2xl flex flex-col items-center justify-center
                dark:bg-gray-950 p-1'>
